...
\begin{enumerate}
    ...
    \item \textbf{\underline{Resultados:}} 
        ...
        \insertimage[]{img/4.png}{width=10cm}{Visualización peces y voxles tipo \textit{a}}

        Luego, al apretar la tecla \textit{C}, aparecen los voxeles del tipo \textit{c}.
        \insertimage[]{img/5.png}{width=10cm}{Visualización peces y voxles tipo \textit{a} y \textit{c}}
        ...
        \insertimage[]{img/6.png}{width=10cm}{Visualización peces y voxles tipo \textit{b} y \textit{c}}
